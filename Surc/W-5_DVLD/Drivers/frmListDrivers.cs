...
namespace Basis_W_App.Drivers
{
    ...
    {
        private DataTable dtAllDrivers;
        ...
        private void frmListDrivers_Load(object sender, EventArgs e)
        {
            ...
            if (dgvDrivers.Rows.Count > 0)
            {
                ...
                dgvDrivers.Columns[5].HeaderText = "Date";
        ...
        private void txtFilterValue_TextChanged(object sender, EventArgs e)
        {
            ...
            if (FilterColumn != "FullName" && FilterColumn != "NationalNo")
                ...
                dtAllDrivers.DefaultView.RowFilter = string.Format("[{0}] = {1}", FilterColumn, txtFilterValue.Text.Trim());
            else
                dtAllDrivers.DefaultView.RowFilter = string.Format("[{0}] LIKE '{1}%'", FilterColumn, txtFilterValue.Text.Trim());

            lblRecordsCount.Text = dtAllDrivers.Rows.Count.ToString();
        }
